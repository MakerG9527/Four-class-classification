...
# 5. 初始化模型、损失函数和优化器
model = LSTM(input_dim, hidden_dim, num_layers, num_classes, dropout_prob=0.02, l2_reg=0.01)
...
# 定义日志文件的路径
log_dir = '../logs'
log_path = os.path.join(log_dir, f'LSTM_training_logs_Step{step}_Epochs{epochs}.txt')
